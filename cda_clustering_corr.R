cda_clustering_corr <- function(dat, colinds, sensitivity = .001){
  ...
  #Return the cluster memberships as a character vector
  return(as.character(membership(ebc)))
